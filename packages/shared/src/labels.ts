...
export const errorCodeLabels: Record<Locale, Record<ErrorCode, string>> = {
  fr: {
    ...
    SERVICE_REQUEST_ALREADY_OPEN: 'Une demande de véhicule est déjà en cours.',
    SERVICE_REQUEST_CLOSED: 'Cette demande n’attend plus d’offre.',
  ...
  en: {
    ...
    SERVICE_REQUEST_ALREADY_OPEN: 'A request is already in progress.',
    SERVICE_REQUEST_CLOSED: 'This request is no longer taking offers.',
    DRIVER_NOT_APPROVED: 'Your driver file is not approved.',
    DRIVER_BUSY: 'A ride is already under way.',
    OFFER_NOT_ACCEPTABLE: 'This offer is no longer valid.',
    OFFER_ALREADY_TAKEN: 'That driver has just been taken. Pick another offer.',
    RIDE_NOT_PAID: 'The passenger has not paid for this ride yet.',
